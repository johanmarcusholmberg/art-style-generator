...
export const STYLE_RULES: Record<string, StyleRules> = {
  ...
  urbannoir: {
    visualGoal: ["high-contrast illustrative noir wall art", "cinematic monochrome poster with print-safe drama", "bold black-and-white film-noir illustration"],
    styleAnchors: ["illustrative film-noir poster", "high-contrast black-and-white illustration", "Mike Mignola and Frank Miller noir illustration", "cinematic monochrome poster art"],
    styleRules: ["bold graphic shadow shapes — not photographic noise", "crisp silhouettes with strong figure-ground separation", "controlled illustrative grain used only as a textural accent, never as the subject", "strictly monochrome — black, white, and a small range of greys", "dramatic chiaroscuro composed as large readable shapes"],
    compositionRules: ["cinematic poster framing with strong focal silhouette", "dramatic light/shadow blocking rather than naturalistic photo lighting", "large readable shadow shapes that hold up at 50×70 cm print", "all edge details remain crisp and intentional"],
    colorRules: ["strictly black and white — no color whatsoever", "deep solid blacks and clean whites with controlled grey midtones", "any grain treated as an illustrative texture, not photographic noise"],
    qualityRules: ["print-ready illustrative monochrome with crisp edges", "no photographic blur or low-light softness", "controlled grain that survives upscale"],
    avoidRules: ["photographic noise", "muddy shadows", "low-resolution grain", "blurry face", "realistic surveillance photo", "soft low-light photo", "any text, watermarks, or script"],
    blockedTraits: ["color of any kind", "photographic motion blur", "low-light photo softness", "muddy grey shadows"],
    edgeSafety: ["bold black shapes and silhouettes near the edges are part of the composition and must remain crisp"],
  },
  "urbannoir-freestyle": {
    visualGoal: ["high-contrast illustrative noir print applied to any subject", "cinematic monochrome poster art"],
    styleAnchors: ["illustrative film-noir poster", "high-contrast black-and-white illustration", "cinematic monochrome composition"],
    styleRules: ["bold graphic shadow shapes over photographic noise", "crisp silhouettes and confident chiaroscuro", "monochrome with controlled illustrative grain"],
    compositionRules: ["cinematic framing with strong focal silhouette", "dramatic light/shadow blocking as large readable shapes", "edge silhouettes preserved crisply"],
    colorRules: ["black and white only — no color", "solid blacks, clean whites, controlled greys"],
    qualityRules: ["print-ready illustrative monochrome", "no photographic softness or motion blur"],
    avoidRules: ["photographic noise", "muddy shadows", "low-resolution grain", "blurry face", "realistic surveillance photo", "soft low-light photo", "any text or script"],
    blockedTraits: ["color tints", "low-light photo softness", "muddy grey shadows"],
    edgeSafety: ["bold black silhouettes near the edges are part of the artwork"],
  },
  screenprint: {
  ...
  whimsical_japanese: {
    ...
    avoidRules: [
      ...
      "any rendered text, headlines, kanji captions, or labels",
  ...
  artnouveau: {
    visualGoal: ["ornamental Art Nouveau decorative poster", "premium late-19th-century exhibition-poster wall art", "elegant Mucha-style decorative illustration"],
    styleAnchors: ["Art Nouveau decorative poster", "Alphonse Mucha exhibition poster", "late-19th-century ornamental illustration", "vintage decorative poster art"],
    styleRules: ["flowing ornamental linework with graceful curves", "elegant decorative borders and ornamental frame elements", "botanical motifs woven through the composition", "flat but rich color areas with refined illustration — no photorealism", "vintage exhibition-poster elegance"],
    compositionRules: ["strong central composition with one graceful focal subject", "decorative frame or arch composition around the subject", "balanced symmetry typical of Art Nouveau posters", "ornamental borders near the edges are part of the artwork"],
    colorRules: ["refined harmonious palette of 4–6 muted decorative colors", "warm muted earth tones, sage, dusty rose, cream, deep teal, gold ochre", "flat but rich color areas — no glossy gradients"],
    qualityRules: ["premium decorative poster quality", "crisp ornamental linework at print resolution", "elegant collectible wall-art finish"],
    avoidRules: ["photorealistic", "3D render", "corporate minimalism", "messy collage", "harsh cyberpunk", "modern glossy advertising", "any rendered text or logos"],
    blockedTraits: ["photorealism", "3D rendering", "glossy modern advertising", "cyberpunk neon"],
    edgeSafety: ["decorative borders, ornamental flourishes and botanical frame elements at the image edges are part of the poster and must be preserved fully"],
  },
  "artnouveau-freestyle": {
    visualGoal: ["Art Nouveau decorative poster applied to any subject", "premium ornamental wall-art"],
    styleAnchors: ["Art Nouveau decorative poster", "Mucha-style ornamental illustration", "vintage exhibition-poster aesthetic"],
    styleRules: ["flowing ornamental linework", "decorative botanical borders", "flat rich color areas with refined illustration"],
    compositionRules: ["graceful central composition", "decorative arch or frame around the subject", "ornamental borders near the edges are part of the artwork"],
    colorRules: ["refined muted decorative palette", "warm earth tones with cream and gold ochre"],
    qualityRules: ["premium decorative poster quality", "crisp ornamental linework"],
    avoidRules: ["photorealistic", "3D render", "corporate minimalism", "messy collage", "harsh cyberpunk", "modern glossy advertising", "any rendered text"],
    blockedTraits: ["photorealism", "3D rendering", "glossy advertising"],
    edgeSafety: ["decorative borders and botanical frame elements at the edges must be preserved"],
  },

  midcenturymodern: {
    visualGoal: ["warm 1950s-inspired mid-century modern illustration", "collectible travel/editorial poster wall art", "Charley Harper / Eames-era graphic illustration"],
    styleAnchors: ["mid-century modern illustration", "1950s editorial poster", "Charley Harper wildlife illustration", "vintage travel poster"],
    styleRules: ["simplified geometric forms with playful charm", "clean silhouettes — no fussy detail", "subtle paper-grain texture suggestion, never noisy", "warm muted mid-century palette", "graphic poster construction with clear hierarchy"],
    compositionRules: ["balanced graphic composition with strong focal subject", "intentional negative space framing the subject", "travel-poster friendly layout that reads at 50×70 cm", "all composition elements stay fully within the boundary"],
    colorRules: ["warm muted palette of 3–5 colors", "draw from mustard, terracotta, olive, sage, dusty blue, cream, burnt orange, deep teal", "flat color blocks — no glossy gradients"],
    qualityRules: ["premium illustrated poster quality with subtle warmth", "crisp graphic edges at print resolution", "collectible mid-century editorial finish"],
    avoidRules: ["photorealistic", "3D render", "glossy gradients", "excessive detail", "neon cyberpunk", "cluttered composition", "any rendered text or logos"],
    blockedTraits: ["photorealism", "3D rendering", "glossy digital sheen", "neon palettes"],
    edgeSafety: ["graphic shapes and silhouettes that touch the image edges are intentional poster framing — preserve them"],
  },
  "midcenturymodern-freestyle": {
    visualGoal: ["mid-century modern illustration applied to any subject", "collectible warm editorial poster"],
    styleAnchors: ["mid-century modern illustration", "1950s editorial poster", "vintage travel poster aesthetic"],
    styleRules: ["simplified geometric forms", "clean silhouettes with minimal fussy detail", "warm muted mid-century palette"],
    compositionRules: ["balanced graphic composition", "intentional negative space", "travel-poster friendly layout"],
    colorRules: ["warm muted palette of 3–5 colors", "mustard / terracotta / olive / dusty blue / cream"],
    qualityRules: ["premium illustrated poster quality", "crisp graphic edges"],
    avoidRules: ["photorealistic", "3D render", "glossy gradients", "excessive detail", "neon cyberpunk", "cluttered composition", "any rendered text"],
    blockedTraits: ["photorealism", "3D rendering", "neon palettes"],
    edgeSafety: ["silhouettes at the image edges are part of the poster — preserve them"],
  },

  loosewatercolor: {
    visualGoal: ["soft expressive loose watercolor artwork", "airy painterly wall art with handmade character", "elegant but imperfect watercolor composition"],
    styleAnchors: ["loose expressive watercolor", "soft pigment blooms and washes", "airy painterly illustration", "handmade watercolor character"],
    styleRules: ["broad watercolor washes with visible pigment blooms", "expressive brush edges — never tight or vector-clean", "airy white space woven through the composition", "gentle natural palette with subtle layering", "handmade paper feel"],
    compositionRules: ["elegant but imperfect composition with breathing room", "clear subject silhouette visible through loose washes", "airy negative space — at least 30–40% of canvas", "loose edges at the image boundary are part of the artwork"],
    colorRules: ["gentle natural watercolor palette of 4–6 harmonious tones", "soft layered washes with visible bloom edges", "no oversaturated digital color"],
    qualityRules: ["museum-quality loose watercolor artwork", "visible pigment bloom and brush character preserved", "print-ready watercolor with broad strong washes"],
    avoidRules: ["photorealistic", "hard vector edges", "3D render", "overly sharp digital detail", "muddy overworked paint", "plastic texture", "any rendered text"],
    blockedTraits: ["photorealism", "hard vector edges", "3D rendering", "plastic digital texture"],
    edgeSafety: ["soft watercolor edges and pigment blooms near the borders are part of the artwork — preserve them"],
  },
  "loosewatercolor-freestyle": {
    visualGoal: ["loose expressive watercolor applied to any subject", "soft painterly wall art"],
    styleAnchors: ["loose watercolor illustration", "soft pigment blooms and washes", "airy handmade watercolor"],
    styleRules: ["broad expressive watercolor washes", "soft pigment blooms with visible bleed edges", "gentle layered palette"],
    compositionRules: ["airy composition with breathing room", "clear subject silhouette through loose washes", "loose edges at the boundary are part of the artwork"],
    colorRules: ["gentle natural watercolor palette", "soft layered washes"],
    qualityRules: ["museum-quality loose watercolor", "visible pigment bloom preserved"],
    avoidRules: ["photorealistic", "hard vector edges", "3D render", "overly sharp digital detail", "muddy overworked paint", "plastic texture", "any rendered text"],
    blockedTraits: ["photorealism", "hard vector edges", "3D rendering"],
    edgeSafety: ["soft watercolor edges and blooms near the borders are part of the artwork"],
  },
};
