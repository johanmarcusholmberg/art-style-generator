...
export const STYLE_RULES: Record<string, StyleRules> = {
  ...
  whimsical_japanese: {
    visualGoal: [
      "whimsical hand-illustrated Japanese-inspired poster",
      "charming anthropomorphic animal character as the storybook hero",
      "feels like a printed wall-art poster on warm aged paper",
    ],
    styleAnchors: [
      "hand-painted gouache and watercolor illustration",
      "soft Japanese-inspired storybook poster",
      "anthropomorphic animal character art",
      "hand-inked outlines on textured paper",
      "vintage print poster aesthetic",
    ],
    styleRules: [
      "single charming anthropomorphic animal character as the hero subject (fox, frog, rabbit, tanuki, cat, crane, bear, etc.)",
      "Japanese-inspired clothing, props, food, or setting details (kimono, yukata, tea bowl, ramen, dumplings, lanterns, noren curtains, fans, sake)",
      "visible hand-drawn ink outlines — refined, varied weight, never harsh or digital",
      "soft gouache / watercolor washes with gentle paint texture and slight pigment pooling",
      "subtle vintage paper grain and faint print imperfections throughout",
      "flat painted illustration with soft depth — never 3D, never glossy",
      "calm, quiet, storybook mood — slightly nostalgic and whimsical",
      "centered poster composition with the character framed comfortably",
    ],
    compositionRules: [
      "vertical poster composition suitable for a framed wall print (5:7 / 50×70 cm friendly)",
      "single centered hero subject with clear focal point",
      "generous quiet negative space around the character",
      "simple, minimal background — a small prop, bowl, lantern, plant, or soft pattern is enough",
      "no busy cinematic backgrounds or crowded scenes",
      "any small accents near the edges are part of the artwork — preserve them fully",
    ],
    colorRules: [
      "muted earthy vintage palette: sage green, indigo, dusty blue, terracotta, cream, soft mustard",
    ...
    qualityRules: [
      "premium illustrated poster quality",
      "visible brush and ink texture preserved at full resolution",
      "crisp readable composition at 50×70 cm print scale",
      "tasteful, calm, artisanal storybook feel",
    ],
    avoidRules: [
      "photorealism",
    ...
    edgeSafety: [
      "soft paper texture, paint edges, and any small props near the borders are part of the poster — preserve them fully",
      "do not crop or fade the painted character or props at the image boundary",
    ],
  },
  "whimsical_japanese-freestyle": {
    visualGoal: [
      "whimsical hand-illustrated Japanese-inspired poster applied to any subject",
      "charming storybook poster art with warm vintage character",
      "feels like a printed wall-art poster on warm aged paper",
    ],
    styleAnchors: [
      "hand-painted gouache and watercolor illustration",
    ...
    styleRules: [
      "the chosen subject is the centered hero — keep it singular and charming",
      "preserve Japanese-inspired art direction even on non-Japanese subjects (palette, gouache feel, ink outlines, paper texture)",
      "visible hand-drawn ink outlines — refined, varied weight, never harsh or digital",
      "soft gouache / watercolor washes with gentle paint texture",
      "subtle vintage paper grain and faint print imperfections throughout",
      "flat painted illustration with soft depth — never 3D, never glossy",
      "calm, quiet, storybook mood — slightly nostalgic and whimsical",
    ],
    compositionRules: [
      ...
      "simple, minimal background — small supporting prop or soft pattern only",
      "no busy cinematic backgrounds or crowded scenes",
      "any small accents near the edges are part of the artwork — preserve them fully",
    ],
    colorRules: [
