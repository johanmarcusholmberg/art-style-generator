...
const navItems: StyleNavItem[] = [
  ...
  { to: "/urbannoir", emoji: "🖤", label: "Urban Noir" },
  { to: "/screenprint", emoji: "🖨️", label: "Screen Print" },
  { to: "/risograph", emoji: "📠", label: "Risograph" },
  { to: "/retrocomic", emoji: "💥", label: "Retro Comic" },
  { to: "/pulpmagazine", emoji: "📕", label: "Pulp Magazine" },
  { to: "/tattooflash", emoji: "🔥", label: "Tattoo Flash" },
  { to: "/brutalistposter", emoji: "⬛", label: "Brutalist" },
  { to: "/xeroxzine", emoji: "📋", label: "Xerox Zine" },
