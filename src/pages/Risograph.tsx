...
import { RISOGRAPH_STYLE } from "@/lib/style-config";
import StyleNav from "@/components/StyleNav";

const styleConfig = RISOGRAPH_STYLE;
    ...
    <div className="min-h-screen bg-background paper-texture">
      ...
      <header className="pt-10 pb-12 text-center px-4">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto text-sm leading-relaxed">
          Describe a subject and watch it rendered as a layered risograph print with grainy inks, spot colors, and slight misregistration.
        </p>
      ...
      <footer className="pb-8 text-center">
        <p className="text-muted-foreground text-xs font-display tracking-widest">📠 Risograph Studio</p>
      </footer>
