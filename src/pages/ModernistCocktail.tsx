...
import { MODERNISTCOCKTAIL_STYLE } from "@/lib/style-config";
import StyleNav from "@/components/StyleNav";

const styleConfig = MODERNISTCOCKTAIL_STYLE;

const ModernistCocktail = () => {
  ...
  return (
    <div className="min-h-screen bg-background paper-texture">
      <StyleNav activePath="/modernist-cocktail" />
      ...
      <header className="pt-10 pb-12 text-center px-4">
        ...
        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-foreground leading-tight mb-4">
          Modernist Cocktail<br />
          <span className="text-primary">Poster Generator</span>
        </h1>
        <p className="text-muted-foreground max-w-lg mx-auto text-sm leading-relaxed">
          Bold geometric cocktail, coffee, wine and spirit posters — limited palettes,
          flat shapes, mid-century and Bauhaus influence, collectible wall art.
        </p>
      ...
      <footer className="pb-8 text-center">
        <p className="text-muted-foreground text-xs font-display tracking-widest">🍸 Modernist Poster Studio</p>
      </footer>
...
export default ModernistCocktail;
