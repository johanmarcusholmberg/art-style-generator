...
import { MIDCENTURYMODERN_STYLE } from "@/lib/style-config";
import StyleNav from "@/components/StyleNav";

const styleConfig = MIDCENTURYMODERN_STYLE;

const MidCenturyModern = () => {
    ...
    <div className="min-h-screen bg-background paper-texture">
      ...
      <header className="pt-10 pb-12 text-center px-4">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto text-sm leading-relaxed">
          Describe a subject and watch it rendered as a warm 1950s-inspired
          editorial poster — simplified shapes, playful geometry, and charming travel-poster composition.
        </p>
      ...
      <footer className="pb-8 text-center">
        <p className="text-muted-foreground text-xs font-display tracking-widest">🌞 Mid-Century Studio</p>
      </footer>
