...
import { URBANNOIR_STYLE } from "@/lib/style-config";
import StyleNav from "@/components/StyleNav";

const styleConfig = URBANNOIR_STYLE;
    ...
    <div className="min-h-screen bg-background paper-texture">
      ...
      <header className="pt-10 pb-12 text-center px-4">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto text-sm leading-relaxed">
          Describe a scene and watch it rendered as gritty black-and-white street photography art — raw, high contrast, film grain.
        </p>
      ...
      <footer className="pb-8 text-center">
        <p className="text-muted-foreground text-xs font-display tracking-widest">🖤 Urban Noir Studio</p>
      </footer>
