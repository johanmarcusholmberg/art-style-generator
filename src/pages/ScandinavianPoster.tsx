...
import { SCANDINAVIANPOSTER_STYLE } from "@/lib/style-config";
import StyleNav from "@/components/StyleNav";

const styleConfig = SCANDINAVIANPOSTER_STYLE;

const ScandinavianPoster = () => {
  ...
  return (
    <div className="min-h-screen bg-background paper-texture">
      <StyleNav activePath="/scandinavian-poster" />
      ...
      <header className="pt-10 pb-12 text-center px-4">
        <p className="font-display text-muted-foreground text-sm tracking-[0.3em] uppercase mb-3">
          Scandinavian Poster · Calm & Timeless
        </p>
        ...
        <p className="text-muted-foreground max-w-lg mx-auto text-sm leading-relaxed">
          Describe a subject and watch it become a calm, balanced Nordic poster —
          flat illustration, muted palette, generous negative space.
        </p>
      ...
      <footer className="pb-8 text-center">
        <p className="text-muted-foreground text-xs font-display tracking-widest">🇸🇪 Nordic Studio</p>
      </footer>
...
export default ScandinavianPoster;
