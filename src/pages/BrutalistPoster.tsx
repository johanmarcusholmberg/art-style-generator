...
import { BRUTALISTPOSTER_STYLE } from "@/lib/style-config";
import StyleNav from "@/components/StyleNav";

const styleConfig = BRUTALISTPOSTER_STYLE;

const BrutalistPoster = () => {
    ...
    <div className="min-h-screen bg-background paper-texture">
      ...
      <header className="pt-10 pb-12 text-center px-4">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto text-sm leading-relaxed">
          Describe a subject and watch it rendered as a harsh brutalist poster with bold shapes, stark contrast, and raw graphic energy.
        </p>
      ...
      <footer className="pb-8 text-center">
        <p className="text-muted-foreground text-xs font-display tracking-widest">⬛ Brutalist Poster Studio</p>
      </footer>
...
export default BrutalistPoster;