...
export const PRINT_FORMATS: PrintFormat[] = [
  ...
  },
  {
    ...
    heightCm: 50,
    aspectRatio: "7:5",
    aspectRatioDecimal: 70 / 50,
    promptHint: "horizontal 7:5 poster format suitable for 70 × 50 cm print",
    recommendedGenerationWidth: 2240,
    recommendedGenerationHeight: 1600,
    preferredPixelWidth: 8268,
    preferredPixelHeight: 5906,
    fallbackPixelWidth: 4134,
  ...
  },
  {
    ...
    heightCm: 100,
    aspectRatio: "7:10",
    aspectRatioDecimal: 70 / 100,
    promptHint: "vertical 7:10 poster format suitable for 70 × 100 cm print",
    recommendedGenerationWidth: 1568,
    recommendedGenerationHeight: 2240,
    preferredPixelWidth: 8268,
    preferredPixelHeight: 11811,
    fallbackPixelWidth: 4134,
    fallbackPixelHeight: 5906,
    allowUpscale: true,
    exportType: "poster",
  },
  {
